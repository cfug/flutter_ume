...
[![platforms](https://img.shields.io/badge/platforms-ios%20%7C%20android%20%7C%20web%20%7C%20macos%20%7C%20windows%20%7C%20linux-lightgrey)](https://pub.dev/packages/flutter_ume_plus) [![license](https://img.shields.io/github/license/mdddj/flutter_ume.svg)](https://github.com/mdddj/flutter_ume/blob/master/LICENSE)

[![pub package](https://img.shields.io/pub/v/flutter_ume_plus.svg)](https://pub.dev/packages/flutter_ume_plus)
[![pub package](https://img.shields.io/pub/likes/flutter_ume_plus.svg)](https://pub.dev/packages/flutter_ume_plus)
[![pub package](https://img.shields.io/pub/points/flutter_ume_plus.svg)](https://pub.dev/packages/flutter_ume_plus)
[![pub package](https://img.shields.io/pub/popularity/flutter_ume_plus.svg)](https://pub.dev/packages/flutter_ume_plus)
[![pub package](https://img.shields.io/pub/publisher/flutter_ume_plus.svg)](https://pub.dev/packages/flutter_ume_plus)

<img src="https://github.com/mdddj/flutter_ume/raw/master/ume_logo_256.png" width = "128" height = "128" alt="banner" />

**Since `^1.0.0`, flutter_ume_plus starts adapting to the Flutter 3. See [Quick Start] to learn more.**
...
3. Import packages
    ...
    import 'package:flutter_ume_kit_perf_plus/flutter_ume_kit_perf_plus.dart'; // Performance kits
    import 'package:flutter_ume_kit_show_code_plus/flutter_ume_kit_show_code_plus.dart'; // Show Code
...
<table border="1" width="100%">
    ...
    <tr>
        <td width="33.33%" align="center"><img src="https://github.com/mdddj/flutter_ume/raw/master/screenshots/widget_info.png" width="100%" alt="Widget Info" /></br>Widget Info</td>
        <td width="33.33%" align="center"><img src="https://github.com/mdddj/flutter_ume/raw/master/screenshots/widget_detail.png" width="100%" alt="Widget Detail" /></br>Widget Detail</td>
        <td width="33.33%" align="center"><img src="https://github.com/mdddj/flutter_ume/raw/master/screenshots/align_ruler.png" width="100%" alt="Align Ruler" /></br>Align Ruler</td>
    </tr>
    <tr>
        <td width="33.33%" align="center"><img src="https://github.com/mdddj/flutter_ume/raw/master/screenshots/color_picker.png" width="100%" alt="Color Picker" /></br>Color Picker</td>
        <td width="33.33%" align="center"><img src="https://github.com/mdddj/flutter_ume/raw/master/screenshots/color_sucker.png" width="100%" alt="Color Sucker" /></br>Color Sucker</td>
        <td width="33.33%" align="center"><img src="https://github.com/mdddj/flutter_ume/raw/master/screenshots/touch_indicator.png" width="100%" alt="Touch Indicator" /></br>Touch Indicator</td>
    </tr>
    <tr>
    ...
    <tr>
        <td width="33.33%" align="center"><img src="https://github.com/mdddj/flutter_ume/raw/master/screenshots/memory_info.png" width="100%" alt="Memory Info" /></br>Memory Info</td>
        <td width="33.33%" align="center"><img src="https://github.com/mdddj/flutter_ume/raw/master/screenshots/perf_overlay.png" width="100%" alt="Perf Overlay" /></br>Perf Overlay</td>
    </tr>
    <tr>
        <td width="33.33%" align="center"></td>
    </tr>
    ...
    <tr>
        <td width="33.33%" align="center"><img src="https://github.com/mdddj/flutter_ume/raw/master/screenshots/cpu_info.png" width="100%" alt="CPU Info" /></br>CPU Info</td>
        <td width="33.33%" align="center"><img src="https://github.com/mdddj/flutter_ume/raw/master/screenshots/device_info.png" width="100%" alt="Device Info" /></br>Device Info</td>
    </tr>
    <tr>
        <td width="33.33%" align="center"></td>
    </tr>
    ...
    <tr>
        <td width="33.33%" align="center"><img src="https://github.com/mdddj/flutter_ume/raw/master/screenshots/show_code.png" width="100%" alt="Show Code" /></br>Show Code</td>
    </tr>
    <tr>
        <td width="33.33%" align="center"></td>
    </tr>
    ...
    <tr>
        <td width="33.33%" align="center"><img src="https://github.com/mdddj/flutter_ume/raw/master/screenshots/console.png" width="100%" alt="Console" /></br>Console</td>
    </tr>
    <tr>
        <td width="33.33%" align="center"></td>
    </tr>
...
For more details, see [./kits/flutter_ume_kit_ui/lib/components/color_picker/color_picker.dart](https://github.com/mdddj/flutter_ume/blob/master/kits/flutter_ume_kit_ui/lib/components/color_picker/color_picker.dart) and [./kits/flutter_ume_kit_ui/lib/components/touch_indicator/touch_indicator.dart](https://github.com/mdddj/flutter_ume/blob/master/kits/flutter_ume_kit_ui/lib/components/touch_indicator/touch_indicator.dart).
...
**Once you use flutter_ume_plus in Release/Profile mode, you agree that you will**
**bear the relevant risks by yourself.**

**The maintainer of flutter_ume_plus does not assume any responsibility for the accident**
**caused by this.**
...
1. In `pubspec.yaml`, `flutter_ume_plus` and plugins should be write below `dependencies` rather than `dev_dependencies`.
...
- The TouchIndicator uses the pub package [touch_indicator](https://pub.dev/packages/touch_indicator).
- The ColorPicker keeps its eyedropper implementation inside `flutter_ume_kit_ui`, instead of carrying the vendored `cyclop` package.
